  ...
  try {
    generated = await generateReportAndPlanOpenAI({
      ...
      possibility: {
        ...
        entregaPrincipal: possibility.entregaPrincipal,
        quemPagaria: possibility.quemPagaria,
        comoSeriaRotina: possibility.comoSeriaRotina,
        porQueApareceu: possibility.porQueApareceu,
        capacidadesAproveitaveis: possibility.capacidadesAproveitaveis,
        aprendizagensPrioritarias: possibility.aprendizagensPrioritarias,
        primeiraVersaoPossivel: possibility.primeiraVersaoPossivel,
