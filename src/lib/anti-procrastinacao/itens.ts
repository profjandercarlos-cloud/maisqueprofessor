...
export const ANTI_PROCRASTINACAO_ITENS: AntiProcrastinacaoItem[] = [
  ...
  },
  {
    ...
    explicacao:
      "Recompensas distantes, como o resultado final do plano lá na semana 12, não sustentam o hábito no dia a dia. Você precisa de algo que sinta bem agora, logo depois de agir, pro cérebro associar a ação a algo bom.",
